  ...
  return (
    <>
      <div className="col-12 text-center inicio-footer">
        <img className="logo img-fluid p-1" src="/images/logo.png" alt="Logo AgroMX" />
      ...
      <div className="container-fluid text-white py-4 final-footer">
        <div className="row">
          ...
          <div className="col-4 col-md-3 col-lg-3 text-center">
            ...
            <a href="/public/sources/pages/acercaDeNosotros/acercaDe.html" style={{ color: "white", textDecoration: "none" }}><h5>Developer Team</h5></a>
            <a href="/public/sources/pages/productos/nuevosProductos.html" style={{ color: "white", textDecoration: "none" }}><h5>Nuevos Productos</h5></a>
          </div>


          {/* Registráte */}
          <div className="col-4 col-md-3 col-lg-3 text-center">
            <a href="/public/sources/pages/contacto/contacto.html" style={{ color: "white", textDecoration: "none" }}><h5>Regístrate</h5></a>
